      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: IconButton(
              icon: Icon(isSoundEnabled ?  Icons.volume_up_rounded :  Icons.volume_off_rounded, size: 50, color: Colors.black,),
              onPressed: (){
                isSoundEnabled ? isSoundEnabled = false :  isSoundEnabled = true;
